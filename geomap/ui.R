			...
			tipify(
				selectInput("colSelect", 
				            ...
				            choices = c("Febre" = 'fever_count',
				                        ...
				                        "Febre y tos" = 'fever_cough_count',
				                        "Febre y dificultad a respirar" = 'fever_breath_count',
				                        "Tos y dificultad a respirar" = 'cough_breath_count',
				                        "Febre y tos y dificultad a respirar" = 'fever_cough_breath_count')), 
